((k,g)=>{XF.Message=XF.Message||{};XF.Message.insertMessages=(a,b,c,d)=>{XF.setupHtmlInsert(a,(e,f,h)=>{(f=b.querySelector(".js-replyNoMessages"))&&XF.Animate.fadeUp(f);e=XF.isCreatedContainer(e)?Array.from(e.childNodes):[e];e.forEach(l=>{l.tagName&&XF.Message.insertMessage(l,b,c)});d&&d(e.filter(l=>l.nodeType===Node.ELEMENT_NODE))})};XF.Message.insertMessage=(a,b,c)=>{const d=b.firstElementChild;XF.display(a,"none");d&&d.matches("form")&&!c?d.after(a):c?b.append(a):b.prepend(a);XF.Animate.fadeDown(a);
