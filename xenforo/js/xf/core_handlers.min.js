...
var f;XF.on(m,"resize",()=>{f&&clearTimeout(f);f=setTimeout(this.updateScroll.bind(this),100)});if(e=a.querySelector(this.options.autoScroll))d=this.target.clientWidth,e=XF.dimensions(e),XF.isRtl()?80>e.left&&XF.normalizedScrollLeft(a,-e.right+d-50):e.right>d&&(e.right+80>d?XF.normalizedScrollLeft(a,e.left-50):XF.normalizedScrollLeft(a,e.left-80))}else console.error("no scroll target")},scrollToStart(){this.scrollTo(0)},scrollToEnd(){const a=this.scrollTarget;this.scrollTo(a.scrollWidth-a.offsetWidth)},
scrollTo(a){const b=this.scrollTarget,c=XF.normalizedScrollLeft(b),d=a-c;let e=null;const f=g=>{e||(e=g);g-=e;XF.normalizedScrollLeft(b,c+d*Math.min(g,150)/150);150>g&&m.requestAnimationFrame(f)};m.requestAnimationFrame(f)},move(a){const b=this.scrollTarget,c=XF.normalizedScrollLeft(b);XF.isRtl()&&(a*=-1);XF.normalizedScrollLeft(b,c+a);return XF.normalizedScrollLeft(b)!==c},step(a){XF.isRtl()&&(a*=-1);const b=Math.max(125,Math.floor(.25*this.scrollTarget.clientWidth)),c=XF.normalizedScrollLeft(this.scrollTarget);
...
a.contentTitle;this.fetchUrl=null},getShareOptions(){return{url:this.url}}});XF.MenuClick=XF.Event.newHandler({eventNameSpace:"XFMenuClick",options:{menu:null,targetOpenClass:"is-menuOpen",openClass:"is-active",completeClass:"is-complete",zIndexRef:null,menuPosRef:null,arrowPosRef:null,directionThreshold:.6},menu:null,menuPosRef:null,menuRef:null,arrowPosRef:null,arrowRef:null,scrollFunction:null,isPotentiallyFixed:!1,menuIsUp:!1,menuWidth:0,menuHeight:0,init(){this.options.menu&&(this.menu=XF.findRelativeIf(this.options.menu,
this.target));if(!this.menu||!this.menu.length)for(var a=this.target.nextElementSibling;a;){if(a.hasAttribute("data-menu")){this.menu=a;break}a=a.nextElementSibling}if(this.menu){this.arrowPosRef=this.menuPosRef=this.target;if(this.options.menuPosRef&&(a=XF.findRelativeIf(this.options.menuPosRef,this.target))&&(this.menuPosRef=a,this.options.arrowPosRef)){const b=XF.findRelativeIf(this.options.arrowPosRef,this.target);b.closest(a)&&(this.arrowPosRef=b)}this.target.setAttribute("aria-controls",XF.uniqueId(this.menu));
this.menu.querySelector(".menu-arrow")||(a=XF.createElement("span",{className:"menu-arrow"}),this.menu.insertBefore(a,this.menu.firstChild));XF.DataStore.set(this.menu,"menu-trigger",this);XF.on(this.menu,"click",b=>{b.target.closest("[data-menu-closer]")&&this.close()});XF.on(this.menu,"menu:open",()=>this.open(XF.Feature.has("touchevents")));XF.on(this.menu,"menu:close",()=>this.close());XF.on(this.menu,"menu:reposition",()=>{this.isOpen()&&this.reposition()});XF.on(this.menu,"keydown",this.keyboardEvent.bind(this));
if(a=this.menu.closest(".tooltip"))XF.on(a,"tooltip:hidden",this.close.bind(this));if(a=this.menu.dataset.menuBuilder)if(XF.MenuBuilder[a])XF.MenuBuilder[a](this.menu,this.target,this);else console.error("No menu builder "+a+" found")}else console.error("No menu found for %o",this.target)},click(a){"undefined"!==typeof a.originalEvent&&(a=a.originalEvent);if(!(a.ctrlKey||a.shiftKey||a.altKey)||!this.target.getAttribute("href")){var b=XF.isEventTouchTriggered(a),c=!0;!b&&this.isOpen()&&(c=!1);c&&a.preventDefault();
this.toggle(b,XF.NavDeviceWatcher.isKeyboardNav())}},isOpen(){return this.target.classList.contains(this.options.targetOpenClass)},toggle(a){this.isOpen()?this.close():this.open(a)},open(a){const b=this.menu,c=this.target,d=this.menuPosRef;let e=0;if(!this.isOpen()&&!b.classList.contains("is-disabled")){k.body.append(b);this.updateMenuDimensions();this.updatePositionReferences();XF.hasFixableParent(this.target)&&(this.scrollFunction=()=>{XF.isHidden(c)?this.close():this.repositionFixed(!0)},b.classList.add("menu--potentialFixed"),
XF.on(m,"scroll",this.scrollFunction));if(this.options.zIndexRef){const g=XF.findRelativeIf(this.options.zIndexRef,c);g&&(e=XF.getElEffectiveZIndex(g))}XF.setRelativeZIndex(b,c,0,e);XF.MenuWatcher.onOpen(b,a);this.reposition();c.setAttribute("aria-expanded","true");XF.Transition.addClassTransitioned(c,this.options.targetOpenClass);b.setAttribute("aria-hidden","false");XF.Transition.addClassTransitioned(b,this.options.openClass,()=>{XF.Transition.addClassTransitioned(b,this.options.completeClass)});
XF.Transition.addClassTransitioned(d,this.options.targetOpenClass);a=XF.customEvent("menu:opened",{menu:b});XF.trigger(this.target,a);XF.trigger(b,a);if(!XF.isIOS()||!this.isPotentiallyFixed)XF.on(b,"menu:complete",()=>{setTimeout(()=>XF.autoFocusWithin(b,"[autofocus], [data-menu-autofocus]"),10)});if(a=b.dataset.href){if(!XF.DataStore.get(b,"menu-loading")){XF.DataStore.set(b,"menu-loading",!0);var f=b.dataset.nocache?!1:!0;XF.ajax("get",a,{},g=>{f&&delete b.dataset.href;g.html&&XF.setupHtmlInsert(g.html,
(h,l,p)=>{l=b.dataset.loadTarget;let n=b;l&&(n=b.querySelector(l));n.innerHTML="";XF.isCreatedContainer(h)?n.append(...h.childNodes):n.append(h);XF.trigger(this.target,XF.customEvent("menu:loaded",{html:h,menu:b}));this.updateMenuDimensions();p(!1,n);setTimeout(this.reposition.bind(this),0);XF.trigger(this.target,XF.customEvent("menu:complete",{menu:b}));XF.trigger(b,"menu:complete")})},{cache:f?"default":"reload"}).finally(()=>XF.DataStore.set(b,"menu-loading",!1))}}else XF.trigger(this.target,XF.customEvent("menu:complete",
{menu:b})),XF.trigger(b,"menu:complete")}},reposition(a,b){if(!XF.DataStore.get(this.menu,"ios-scroll-timeout")||a){this.updatePositionReferences();this.menu.style.visibility="hidden";XF.display(this.menu);this.menu.style.position="";this.menu.style.top="";this.menu.style.bottom="";this.menu.style.left="";this.menu.style.right="";a=XF.viewport(m);var c={};c=this.getHorizontalPosition(a,c);c=this.getVerticalPosition(a,c,b);c.display="";c.visibility="";for(let d in c)this.menu.style[d]=c[d]}},repositionFixed(a){const b=
this.menu;if(a&&XF.isIOS()){var c=XF.DataStore.get(b,"ios-scroll-timeout");clearTimeout(c);c=setTimeout(()=>{XF.DataStore.remove(b,"ios-scroll-timeout");this.reposition()},300);XF.DataStore.set(b,"ios-scroll-timeout",c)}else{this.updatePositionReferences();var d=XF.DataStore.get(this.target,"menu-h");a=XF.DataStore.get(b,"menu-reset-timer");if(d&&this.menuRef.left==d[0]&&this.menuRef.width==d[1]){d=m.getComputedStyle(b);var e=XF.viewport(m),f=XF.hasFixedParent(this.target)?"fixed":"absolute",g={top:parseInt(d.top,
10)};this.menuIsUp=this.menu.classList.contains("menu--up");a&&clearTimeout(a);"fixed"==f&&f!=d.position?(g={"transition-property":"none","transition-duration":"0s"},g=this.getVerticalFixedPosition(e,g)):"absolute"==f&&(g={"transition-property":"none","transition-duration":"0s"},g=this.getVerticalAbsolutePosition(e,g));for(c in g)b.style[c]=g[c];b.classList.toggle("menu--up",this.menuIsUp);a=setTimeout(()=>{b.style.transitionProperty="";b.style.transitionDuration=""},250);XF.DataStore.set(b,"menu-reset-timer",
a)}else this.reposition()}},getHorizontalPosition(a,b){var c=!1;let d=0;this.menuWidth>a.width?d=this.menuRef.left-a.left:this.menuRef.left+this.menuRef.width/2>a.width*this.options.directionThreshold?(d=0-this.menuWidth+this.menuRef.width,c=!0):this.menuRef.width>this.menuWidth&&(d=Math.floor((this.menuRef.width-this.menuWidth)/2));d=Math.min(d,a.right-this.menuWidth-this.menuRef.left-5);d=Math.max(d,a.left-this.menuRef.left+5);b.left=this.menuRef.left+d+"px";XF.DataStore.set(this.target,"menu-h",
[this.menuRef.left,this.menuRef.width,d]);this.menu.classList.toggle("menu--left",!c);this.menu.classList.toggle("menu--right",c);a=Math.min(this.arrowRef.left-this.menuRef.left+this.arrowRef.width/2-d,this.menuWidth-20);if(c=this.menu.querySelector(".menu-arrow"))c.style.top="",c.style.left=a+"px";return b},getVerticalPosition(a,b,c){this.menuIsUp=!1;b=!c&&XF.hasFixedParent(this.target)?this.getVerticalFixedPosition(a,b):this.getVerticalAbsolutePosition(a,b);this.menu.classList.toggle("menu--up",
this.menuIsUp);return b},getVerticalFixedPosition(a,b){b.top=Math.max(0,Math.round(this.menuRef.bottom)-a.top)-this.getTopShift()+"px";b.position="fixed";parseInt(b.top)+this.menuHeight+a.top>a.bottom&&this.menuRef.top-this.menuHeight>a.top?(b.top="",b.bottom=a.bottom-this.menuRef.top+5+"px",this.menuIsUp=!0):this.menuIsUp=!1;return b},getVerticalAbsolutePosition(a,b){b.top=this.menuRef.bottom-this.getTopShift()+"px";b.position="";parseInt(b.top,10)+this.menuHeight>a.bottom&&this.menuRef.top-this.menuHeight>
a.top?(b.top="",b.bottom=a.height-this.menuRef.top+5+"px",this.menuIsUp=!0):this.menuIsUp=!1;return b},getTopShift(){return this.menu.classList.contains("menu--structural")?parseInt(XF.config.borderSizeFeature,10):0},updateMenuDimensions(){let a=this.menu.style.display,b=this.menu.style.visibility;XF.display(this.menu);this.menu.style.visibility="hidden";this.menu.clientWidth;this.menuWidth=this.menu.offsetWidth;this.menuHeight=this.menu.offsetHeight;XF.display(this.menu,a);this.menu.style.visibility=
b;return{menuWidth:this.menuWidth,menuHeight:this.menuHeight}},updatePositionReferences(){this.menuRef=XF.dimensions(this.menuPosRef,!0);this.arrowRef=this.arrowPosRef==this.menuPosRef?this.menuRef:XF.dimensions(this.arrowPosRef,!0);return{menuRef:this.menuRef,arrowRef:this.arrowRef}},close(){if(this.isOpen()){var a=this.menu;this.target.setAttribute("aria-expanded","false");XF.Transition.removeClassTransitioned(this.target,this.options.targetOpenClass);a.setAttribute("aria-hidden",!0);a.classList.remove(this.options.completeClass);
XF.Transition.removeClassTransitioned(a,this.options.openClass);XF.Transition.removeClassTransitioned(this.menuPosRef,this.options.targetOpenClass);XF.off(m,"scroll",this.scrollFunction);XF.MenuWatcher.onClose(a);var b=XF.customEvent("menu:closed",{menu:a});XF.trigger(this.target,b);XF.trigger(a,b)}},keyboardEvent(a){if(("ArrowUp"==a.key||"ArrowDown"==a.key)&&XF.Keyboard.isShortcutAllowed(k.activeElement)&&k.activeElement.closest(".menu")==this.menu){var b=k.activeElement;const c=b.closest(".menu").querySelectorAll("a");
b=Array.from(c).indexOf(b)+("ArrowUp"==a.key?-1:1);0>b?b=c.length-1:b>=c.length&&(b=0);c[b].focus();a.preventDefault();a.stopPropagation()}}});XF.OffCanvasClick=XF.Event.newHandler({eventNameSpace:"XFOffCanvasClick",options:{menu:null,openClass:"is-active"},menu:null,init(){this.options.menu&&(this.menu=XF.findRelativeIf(this.options.menu,this.target));this.menu||(this.menu=Array.from(this.target.nextElementSibling).find(b=>void 0!==b.dataset.menu));if(this.menu){XF.on(this.menu,"click",b=>{b.target.matches("[data-menu-close]")&&
this.closeTrigger(b)});XF.on(this.menu,"off-canvas:close",this.closeTrigger.bind(this));XF.on(this.menu,"off-canvas:open",this.openTrigger.bind(this));var a=this.menu.dataset.ocmBuilder;if(a)if(XF.OffCanvasBuilder[a])XF.OffCanvasBuilder[a](this.menu,this);else console.error("No off canvas builder "+a+" found")}else console.error("No menu found for %o",this.target)},click(a){a.preventDefault();this.toggle()},isOpen(){return this.menu.classList.contains(this.options.openClass)},toggle(){this.isOpen()?
this.close():this.open()},openTrigger(a){a.preventDefault();this.open()},open(){if(!this.isOpen()){var a=this.menu;this.addOcmClasses(a);a.setAttribute("aria-hidden","false");XF.trigger(a,"off-canvas:opening");XF.Transition.addClassTransitioned(a,this.options.openClass,()=>XF.trigger(a,"off-canvas:opened"));XF.Modal.open()}},addOcmClasses(a){const b=a.dataset.ocmClass;b&&a.classList.add(...b.split(" "));a.querySelectorAll("[data-ocm-class]").forEach(c=>{c.classList.add(...c.dataset.ocmClass.split(" "))})},
removeOcmClasses(a){const b=a.dataset.ocmClass;b&&a.classList.remove(...b.split(" "));a.querySelectorAll("[data-ocm-class]").forEach(c=>{c.classList.remove(...c.dataset.ocmClass.split(" "))})},closeTrigger(a){a.preventDefault();this.close()},close(a=!1){if(this.isOpen()){var b=this.menu;b.setAttribute("aria-hidden","true");XF.trigger(b,"off-canvas:closing");XF.Transition.removeClassTransitioned(b,this.options.openClass,()=>{XF.trigger(b,"off-canvas:closed");this.removeOcmClasses(b)},a);XF.Modal.close()}}});
XF.OverlayClick=XF.Event.newHandler({eventNameSpace:"XFOverlayClick",options:{cache:!0,overlayConfig:{},forceFlashMessage:!1,followRedirects:!1,closeMenus:!0},overlay:null,loadUrl:null,loading:!1,visible:!1,init(){var a=this.getOverlayHtml();if(a)this.setupOverlay(new XF.Overlay(a,this.options.overlayConfig));else{a=this.getLoadUrl();if(!a)throw Error("Could not find an overlay for target");this.loadUrl=a}this.options.closeMenus&&XF.MenuWatcher.closeAll()},click(a){a.preventDefault();this.toggle()},
toggle(){this.overlay?this.overlay.toggle():this.show()},show(){if(this.overlay)this.overlay.show();else if(!this.loading){this.loading=!0;var a={cache:this.options.cache,beforeShow:b=>{this.overlay=b},init:this.setupOverlay.bind(this)};this.options.followRedirects&&(a.onRedirect=(b,c)=>{this.options.forceFlashMessage?XF.flashMessage(b.message,1E3,()=>XF.redirect(b.redirect)):XF.redirect(b.redirect)});(a=XF.loadOverlay(this.loadUrl,a,this.options.overlayConfig))?a.finally(()=>{setTimeout(()=>{this.loading=
!1},300)}):this.loading=!1}},hide(){this.overlay&&this.overlay.hide()},getOverlayHtml(){var a=this.target.dataset.target;let b;a&&((b=this.target.querySelector(a))||(b=k.querySelector(a)));b||(a=this.target.getAttribute("href"))&&"#"==a.substr(0,1)&&(b=k.querySelector(a));b&&!b.matches(".overlay")&&(b=XF.getOverlayHtml(b));return b?b:null},getLoadUrl(){return this.target.dataset.href||this.target.getAttribute("href")||null},setupOverlay(a){this.overlay=a;a.on("overlay:shown",()=>{this.visible=!0});
a.on("overlay:hidden",()=>{this.visible=!1});if(!this.options.cache&&this.loadUrl)a.on("overlay:hidden",()=>{this.overlay=null});return this.overlay}});XF.OverlayClick.overlayCache={};XF.ScrollToClick=XF.Event.newHandler({eventType:"click",eventNameSpace:"XFScrollToClick",options:{target:null,silent:!1,hash:null,speed:300},scroll:null,init(){var a;const b=this.options.hash,c=this.target.getAttribute("href");this.options.target&&(a=XF.findRelativeIf(this.options.target,this.target));if(!a)if(c&&c.length&&
"#"==c.charAt(0))a=k.querySelector(c);else if(this.options.silent)return;if(a)if(this.scroll=a,!0===b||"true"===b)a=a.getAttribute("id"),this.options.hash=a&&a.length?a:null;else{if(!1===b||"false"===b)this.options.hash=null}else console.error("No scroll target could be found")},click(a){this.scroll&&(a.preventDefault(),XF.smoothScroll(this.scroll,this.options.hash,this.options.speed))}});XF.StyleVariationClick=XF.Event.newHandler({eventType:"click",eventNameSpace:"XFStyleVariationClick",options:{variation:null},
init(){},click(a){a.preventDefault();XF.StyleVariation.updateVariation(this.options.variation)}});XF.Element.register("auto-complete","XF.AutoComplete");XF.Element.register("cookie-consent-form","XF.CookieConsentForm");XF.Element.register("h-scroller","XF.HScroller");XF.Element.register("icon","XF.IconRenderer");XF.Element.register("install-prompt","XF.InstallPrompt");XF.Element.register("notices","XF.Notices");XF.Element.register("number-box","XF.NumberBox");XF.Element.register("page-jump","XF.PageJump");
XF.Element.register("quick-search","XF.QuickSearch");XF.Element.register("search-auto-complete","XF.SearchAutoComplete");XF.Element.register("share-buttons","XF.ShareButtons");XF.Element.register("sticky","XF.Sticky");XF.Element.register("sticky-header","XF.StickyHeader");XF.Element.register("style-variation-input","XF.StyleVariationInput");XF.Element.register("tooltip","XF.Tooltip");XF.Element.register("element-tooltip","XF.ElementTooltip");XF.Element.register("member-tooltip","XF.MemberTooltip");
