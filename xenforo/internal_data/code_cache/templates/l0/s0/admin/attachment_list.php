<?php
// FROM HASH: 694223b80360208a4069881fb0a1e45f
return array(
			...
			foreach ($__vars['attachments'] AS $__vars['attachment']) {
				...
				if ($__vars['attachment']['has_thumbnail']) {
					$__compilerTemp3[] = array(
						...
						'_type' => 'cell',
						'html' => '
									<span class="tooltip-element"><img src="' . $__templater->escape($__vars['attachment']['thumbnail_url']) . '" srcset="' . ($__vars['attachment']['has_retina_thumbnail'] ? ($__templater->escape($__vars['attachment']['retina_thumbnail_url']) . ' 2x') : '') . '" class="attachment-tooltip-image" /></span>
								',
					);
				} else {
					$__compilerTemp3[] = array(
