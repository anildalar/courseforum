<?php
// FROM HASH: 34785f2ee3e2ab0977bfc4fdced56a4c
return array(
...
<div class="block">
	...
	$__compilerTemp20 = array(array(
		'value' => '0',
		'label' => $__vars['xf']['language']['parenthesis_open'] . 'Use default style' . $__vars['xf']['language']['parenthesis_close'],
		'_type' => 'option',
	));
	$__compilerTemp21 = $__templater->method($__vars['styleTree'], 'getFlattened', array(0, ));
	...
	$__compilerTemp23 = $__templater->method($__vars['languageTree'], 'getFlattened', array(0, ));
	if ($__templater->isTraversable($__compilerTemp23)) {
		foreach ($__compilerTemp23 AS $__vars['treeEntry']) {
			$__compilerTemp22[] = array(
