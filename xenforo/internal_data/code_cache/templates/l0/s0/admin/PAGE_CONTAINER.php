<?php
// FROM HASH: 549d456ad0631d62620eeea0217dec03
return array(
	...
	if ($__templater->method($__vars['xf']['style'], 'isVariationsEnabled', array())) {
		...
		if ($__vars['xf']['visitor']['Admin']['admin_style_variation']) {
			...
			' . $__templater->callMacro(null, 'theme_color_meta', array(
				'color' => $__templater->func('parse_less_color', array($__templater->func('property_variation', array('metaThemeColor', $__vars['xf']['visitor']['Admin']['admin_style_variation'], ), false), ), false),
			), $__vars) . '
		';
		} else {
			$__finalCompiled .= '
