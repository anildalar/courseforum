<?php
// FROM HASH: c62b23006369a73bc5993abbf43338cb
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['attachment']['has_thumbnail']) {
		$__finalCompiled .= '
			...
			<a
				class="file-preview ' . ($__vars['canView'] ? 'js-lbImage' : '') . '"
				href="' . $__templater->escape($__vars['attachment']['direct_url']) . '"
				data-type="' . ($__vars['canView'] ? 'image' : '') . '"
				target="_blank">
				<img src="' . $__templater->escape($__vars['attachment']['thumbnail_url']) . '"
					srcset="' . ($__vars['attachment']['has_retina_thumbnail'] ? ($__templater->escape($__vars['attachment']['retina_thumbnail_url']) . ' 2x') : '') . '"
