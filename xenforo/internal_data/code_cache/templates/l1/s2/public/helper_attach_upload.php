<?php
// FROM HASH: a2a7a797c0deebfb38d70ec0c7aeed08
return array(
	...
	if ($__vars['attachment']['has_thumbnail']) {
		$__finalCompiled .= '
			<a class="file-preview js-attachmentView" href="' . $__templater->escape($__vars['attachment']['direct_url']) . '" target="_blank">
				<img src="' . $__templater->func('base_url', array($__vars['attachment']['thumbnail_url'], ), true) . '"
					srcset="' . ($__vars['attachment']['has_retina_thumbnail'] ? ($__templater->func('base_url', array($__vars['attachment']['retina_thumbnail_url'], ), true) . ' 2x') : '') . '"
					class="js-attachmentThumb"
					alt="' . $__templater->escape($__vars['attachment']['filename']) . '"
		...
		<li class="file js-attachmentFile" ' . $__templater->func('mustache', array('#attachment_id', 'data-attachment-id="{{attachment_id}}"', ), true) . '>
			...
			' . $__templater->func('mustache', array('^uploading', '
				' . $__templater->func('mustache', array('#thumbnail_url', '
					' . $__templater->func('mustache', array('#retina_thumbnail_url', '
						<a class="file-preview js-attachmentView" href="' . $__templater->func('mustache', array('link', ), true) . '" target="_blank">
							<img src="' . $__templater->func('mustache', array('thumbnail_url', ), true) . '" srcset="' . $__templater->func('mustache', array('retina_thumbnail_url', ), true) . ' 2x" class="js-attachmentThumb" alt="' . $__templater->func('mustache', array('filename', ), true) . '" />
						</a>
					')) . '
					' . $__templater->func('mustache', array('^retina_thumbnail_url', '
						<a class="file-preview js-attachmentView" href="' . $__templater->func('mustache', array('link', ), true) . '" target="_blank">
