<?php
// FROM HASH: 5abc6f18b2821b9c8ca73a793ba15e71
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="bbImageWrapper ' . $__templater->escape($__vars['alignClass']) . ' js-lbImage" title="' . $__templater->filter($__vars['alt'], array(array('for_attr', array()),), true) . '"
		data-src="' . $__templater->escape($__vars['src']) . '"
		data-type="image"
		data-lb-sidebar-href="' . $__templater->escape($__vars['sidebarHref']) . '"
		data-lb-caption-extra-html="' . $__templater->filter($__vars['captionExtraHtml'], array(array('for_attr', array()),), true) . '"
		data-single-image="1"
	>
