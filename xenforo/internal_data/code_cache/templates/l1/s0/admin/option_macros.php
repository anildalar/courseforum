<?php
// FROM HASH: b134d40252f1ac4d7cf674bbbbf98fa5
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		...
		$__finalCompiled .= '
	';
	} else if ((($__vars['option']['edit_format'] == 'textbox') AND $__vars['formatParams']['asset']) AND !$__templater->test($__vars['formatParams']['asset'], 'empty', array())) {
		$__finalCompiled .= '
		' . $__templater->formAssetUploadRow(array(
			'name' => $__vars['inputName'],
			'value' => $__vars['option']['option_value'],
			'class' => $__vars['formatParams']['class'],
			'asset' => $__vars['formatParams']['asset'],
			'accept' => $__vars['formatParams']['accept'],
		), array(
			'rowclass' => $__vars['rowClass'],
			'label' => $__templater->escape($__vars['option']['title']),
			'hint' => $__templater->escape($__vars['hintHtml']),
