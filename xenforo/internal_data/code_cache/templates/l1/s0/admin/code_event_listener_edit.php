<?php
// FROM HASH: 9dbdd9e6e14fc64ab5caaa8a6fbf61ff
return array(
...
';
	...
	$__compilerTemp2 = '';
	if ($__vars['listener']['Event']) {
		$__compilerTemp2 .= '
							' . $__templater->callMacro('code_event_macros', 'event_details', array(
			'event' => $__vars['listener']['Event'],
		), $__vars) . '
						';
	}
	...
	<div class="block-container">
		...
		'data-desc-url' => $__templater->func('link', array('code-events/get-event-details', ), false),
	), $__compilerTemp1, array(
		'label' => 'Listen to event',
		'html' => '
					<div class="js-descTarget eventDescription" dir="ltr">
						' . $__compilerTemp2 . '
					</div>
				',
	)) . '
