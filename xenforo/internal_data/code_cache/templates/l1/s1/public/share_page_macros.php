<?php
// FROM HASH: 9e69cab00f24b9de66cb3606d8e893b6
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['options']['tweet']['enabled']) {
		$__compilerTemp1 .= '
						<a class="shareButtons-button shareButtons-button--brand shareButtons-button--twitter" href="#' . $__templater->escape($__vars['id']) . '" data-href="https://x.com/intent/tweet?url={url}&amp;text={title}' . ($__vars['xf']['options']['tweet']['via'] ? ('&amp;via=' . $__templater->escape($__vars['xf']['options']['tweet']['via'])) : '') . ($__vars['xf']['options']['tweet']['related'] ? ('&amp;related=' . $__templater->escape($__vars['xf']['options']['tweet']['related'])) : '') . '">
