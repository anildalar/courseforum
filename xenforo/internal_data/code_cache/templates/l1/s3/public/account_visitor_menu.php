<?php
// FROM HASH: e716b46564bf87accbf9f4f5af7c87f5
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canSearch', array())) {
		$__finalCompiled .= '
								<a href="' . $__templater->func('link', array('search/member', null, array('user_id' => $__vars['xf']['visitor']['user_id'], 'content' => 'post', ), ), true) . '" class="fauxBlockLink-linkRow u-concealed">
